...
parser.add_argument('-scriptpath', type=str, action="store", dest="scriptpath", default="/data/project/thymelab/scripts/behavior_published2020/ProcessMotion/") # path for the analysis suite
